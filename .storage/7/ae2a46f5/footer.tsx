    ...
    <footer className="bg-primary text-background">
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div>
            <h3 className="mb-4 font-playfair text-xl font-bold">
              Tcheka Malou
            </h3>
            <p className="mb-4">
              Auteur, formateur, consultant en communication, entrepreneur, et
              plus encore. Explorez les différentes facettes de mon travail et
          ...
          <div>
            ...
            <p className="mb-4">
              Abonnez-vous pour recevoir mes dernières publications et
              actualités.
            </p>
            <form
        ...
        <div className="mt-12 border-t border-background/20 pt-8 text-center">
          <p>© {currentYear} Tcheka Malou. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
