...
export const books: Book[] = [
  {
    id: '1',
    title: 'Le don, un instrument pour le nouvel ordre divin',
    coverImage: '/images/AuthenticCommunication.jpg',
    summary: 'Dans un monde en crise, Le Don révèle les clés divines pour restaurer les Nations',
    buyLink: 'https://example.com/buy-book1',
  },
  {
    id: '2',
    title: 'Gauche Centre Droite & Conscience',
    coverImage: '/images/CareerReinvention.jpg',
    summary: 'Face aux injustices, Le Don offre une lumière prophétique et une clé divine pour notre temps',
    buyLink: 'https://example.com/buy-book2',
  },
  {
    id: '3',
    title: 'Les Yeux de Léa - Comment transformer notre réalité par notre regard',
